...
import { locale as english } from 'app/components/produit/i18n/en'
import { locale as french } from 'app/components/produit/i18n/fr'
import { locale as arabic } from 'app/components/produit/i18n/ar'
@Component({
  selector: 'app-quickaddproduit',
  templateUrl: './quickaddproduit.component.html',
  styleUrls: ['./quickaddproduit.component.scss']
})
export class QuickaddproduitComponent implements OnInit {
